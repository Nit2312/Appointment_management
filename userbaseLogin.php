...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $pid = $_POST['pid'];
    $pateintname = $_POST['pname'];
    $password = $_POST['password'];

    $sql = "SELECT * FROM `try` WHERE pid = '$pid' and password = '$password';";
    $result = mysqli_query($conn, $sql);
    $num = mysqli_num_rows($result);
    if ($num == 1) {
        $login = true;
        $_SESSION['loggedin'] = true;
        $_SESSION['username'] = $pateintname;
        ...
        <div class="login-html">
            ...
            <div class="login-form">
                ...
                ";
                    ...
                    <div class="group">
                        <label for="pass" class="label">Password</label>
                        <input id="pass" type="password" class="input" data-type="password" name="npassword">
                    </div>
                    <div class="group">
                        <div class="group">
                            <label for="pass" class="label">Email Address</label>
                            <input id="pass" type="text" class="input" name="nemail>
                    </div>
                    <div class="group">
                            <label for="pass" class="label">phone number</label>
                            <input id="pass" type="text" class="input" name="nnumber">
                        </div>
                        <div class="group">
