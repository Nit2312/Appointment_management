                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="profile-info-left">
                                                    <h3 class="user-name m-t-0 mb-0"><?php echo $row['pname'] ?></h3>
                                                    <div class="staff-id">Patient ID : <?php echo $row['pid'] ?></div>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <ul class="personal-info">
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="text"><a
                                                                href="#"><?php echo $row['email'] ?></a></span>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                <a href="#/" class="name">Age</a>
                                                                <div><?php echo $row['page'] ?></div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                <a href="#/" class="name">Blood Group</a>
